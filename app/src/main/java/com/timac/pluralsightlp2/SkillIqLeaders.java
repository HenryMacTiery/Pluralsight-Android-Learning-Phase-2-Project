...
public class SkillIqLeaders extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.skill_iq_leaders, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        JsonPlaceHolderApiSkill jsonPlaceHolderApi = retrofit.create(JsonPlaceHolderApiSkill.class);
        Call<List<SkillIQ>> call2 = jsonPlaceHolderApi.getSkillIQs();
        call2.enqueue(new Callback<List<SkillIQ>>() {
            ...
            public void onResponse(Call<List<SkillIQ>> call, Response<List<SkillIQ>> response) {
                ...
                List<SkillIQ> skill = response.body();
                mRecyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
                MyAdapter2 adapter = new MyAdapter2(getContext(), skill);
